...
void test_get_dst_map2D_View2D() {
  ...
  auto dst_map_01_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_01, axis0);
  auto dst_map_10_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_10, axis0);
  auto dst_map_01_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_01, axis1);
  auto dst_map_10_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_10, axis1);
...
void test_get_dst_map3D_View3D() {
  ...
  auto dst_map_012_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_012, axis0);
  auto dst_map_021_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_021, axis0);
  auto dst_map_102_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_102, axis0);
  auto dst_map_120_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_120, axis0);
  auto dst_map_201_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_201, axis0);
  auto dst_map_210_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_210, axis0);

  auto dst_map_012_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_012, axis1);
  auto dst_map_021_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_021, axis1);
  auto dst_map_102_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_102, axis1);
  auto dst_map_120_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_120, axis1);
  auto dst_map_201_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_201, axis1);
  auto dst_map_210_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_210, axis1);

  auto dst_map_012_axis2 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_012, axis2);
  auto dst_map_021_axis2 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_021, axis2);
  auto dst_map_102_axis2 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_102, axis2);
  auto dst_map_120_axis2 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_120, axis2);
  auto dst_map_201_axis2 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_201, axis2);
  auto dst_map_210_axis2 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType>(src_map_210, axis2);
...
TYPED_TEST(TestMapping, View2D) {
  ...
  test_get_dst_map2D_View2D<value_type, layout_type>();
}
...
TYPED_TEST(TestMapping, View3D) {
  ...
  test_get_dst_map3D_View3D<value_type, layout_type>();
}
