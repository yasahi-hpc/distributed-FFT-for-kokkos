...
void test_get_dst_map2D_View2D() {
  ...
  auto dst_map_01_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 2>(src_map_01, 0);
  auto dst_map_10_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 2>(src_map_10, 0);
  auto dst_map_01_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 2>(src_map_01, 1);
  auto dst_map_10_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 2>(src_map_10, 1);
...
void test_get_dst_map3D_View3D() {
  ...
  auto dst_map_012_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_012, 0);
  auto dst_map_021_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_021, 0);
  auto dst_map_102_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_102, 0);
  auto dst_map_120_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_120, 0);
  auto dst_map_201_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_201, 0);
  auto dst_map_210_axis0 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_210, 0);

  auto dst_map_012_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_012, 1);
  auto dst_map_021_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_021, 1);
  auto dst_map_102_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_102, 1);
  auto dst_map_120_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_120, 1);
  auto dst_map_201_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_201, 1);
  auto dst_map_210_axis1 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_210, 1);

  auto dst_map_012_axis2 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_012, 2);
  auto dst_map_021_axis2 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_021, 2);
  auto dst_map_102_axis2 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_102, 2);
  auto dst_map_120_axis2 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_120, 2);
  auto dst_map_201_axis2 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_201, 2);
  auto dst_map_210_axis2 =
      KokkosFFT::Distributed::Impl::get_dst_map<LayoutType, 3>(src_map_210, 2);
