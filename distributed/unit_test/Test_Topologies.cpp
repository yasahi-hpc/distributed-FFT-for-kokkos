...
void test_to_topology_type(std::size_t nprocs) {
  ...
  if (nprocs == 1) {
    ...
    EXPECT_EQ(topo3_4, KokkosFFT::Distributed::Impl::TopologyType::Brick);
    ...
    EXPECT_EQ(topo4_4, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_5, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_6, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_7, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_8, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
  }
}
...
void test_get_common_topology_type(std::size_t nprocs) {
  ...
  if (nprocs == 1) {
    // 1D topology
    auto topo1 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology1, topology1);
    EXPECT_EQ(topo1, KokkosFFT::Distributed::Impl::TopologyType::Shared);

    // Empty
    auto topo1_empty = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology1D_type{0}, topology1);
    EXPECT_EQ(topo1_empty, KokkosFFT::Distributed::Impl::TopologyType::Empty);

    auto topo2_11 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology2_1, topology2_1);
    auto topo2_22 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology2_2, topology2_2);
    auto topo2_12 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology2_1, topology2_2);
    EXPECT_EQ(topo2_11, KokkosFFT::Distributed::Impl::TopologyType::Slab);
    EXPECT_EQ(topo2_22, KokkosFFT::Distributed::Impl::TopologyType::Slab);
    EXPECT_EQ(topo2_12, KokkosFFT::Distributed::Impl::TopologyType::Slab);

    auto topo2_empty_1 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology2D_type{0, nprocs}, topology2_1);
    auto topo2_empty_2 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology2D_type{nprocs, 0}, topology2_2);
    EXPECT_EQ(topo2_empty_1, KokkosFFT::Distributed::Impl::TopologyType::Empty);
    EXPECT_EQ(topo2_empty_2, KokkosFFT::Distributed::Impl::TopologyType::Empty);

    auto topo3_11 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology3_1, topology3_1);
    auto topo3_22 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology3_2, topology3_2);
    auto topo3_33 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology3_3, topology3_3);
    auto topo3_12 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology3_1, topology3_2);
    auto topo3_13 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology3_1, topology3_3);
    auto topo3_23 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology3_2, topology3_3);
    auto topo3_44 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology3_4, topology3_4);
    auto topo3_55 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology3_5, topology3_5);
    EXPECT_EQ(topo3_11, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo3_22, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo3_33, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo3_12, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo3_13, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo3_23, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo3_44, KokkosFFT::Distributed::Impl::TopologyType::Slab);
    EXPECT_EQ(topo3_55, KokkosFFT::Distributed::Impl::TopologyType::Shared);

    auto topo4_11 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_1, topology4_1);
    auto topo4_22 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_2, topology4_2);
    auto topo4_33 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_3, topology4_3);
    auto topo4_44 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_4, topology4_4);
    auto topo4_55 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_5, topology4_5);
    auto topo4_66 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_6, topology4_6);
    auto topo4_12 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_1, topology4_2);
    auto topo4_13 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_1, topology4_3);
    auto topo4_14 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_1, topology4_4);
    auto topo4_15 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_1, topology4_5);
    auto topo4_16 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_1, topology4_6);
    auto topo4_23 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_2, topology4_3);
    auto topo4_24 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_2, topology4_4);
    auto topo4_25 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_2, topology4_5);
    auto topo4_26 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_2, topology4_6);
    auto topo4_34 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_3, topology4_4);
    auto topo4_35 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_3, topology4_5);
    auto topo4_36 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_3, topology4_6);
    auto topo4_45 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_4, topology4_5);
    auto topo4_46 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_4, topology4_6);
    auto topo4_56 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_5, topology4_6);

    auto topo4_77 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_7, topology4_7);
    auto topo4_88 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology4_8, topology4_8);
    EXPECT_EQ(topo4_11, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_22, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_33, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_44, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_55, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_66, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_12, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_13, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_14, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_15, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_16, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_23, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_24, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_25, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_26, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_34, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_35, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_36, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_45, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_46, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_56, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo4_77, KokkosFFT::Distributed::Impl::TopologyType::Slab);
    EXPECT_EQ(topo4_88, KokkosFFT::Distributed::Impl::TopologyType::Shared);
  } else {
    // 1D topology
    auto topo1 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology1, topology1);
    ...
    auto topo2_12 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology2_1, topology2_2);
    EXPECT_EQ(topo2_11, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo2_22, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    EXPECT_EQ(topo2_12, KokkosFFT::Distributed::Impl::TopologyType::Pencil);
    ...
    auto topo3_13 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology3_1, topology3_3);
    auto topo3_14 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology3_1, topology3_4);
    auto topo3_15 = KokkosFFT::Distributed::Impl::get_common_topology_type(
        topology3_1, topology3_5);

    EXPECT_EQ(topo3_11, KokkosFFT::Distributed::Impl::TopologyType::Brick);
    EXPECT_EQ(topo3_22, KokkosFFT::Distributed::Impl::TopologyType::Brick);
    EXPECT_EQ(topo3_33, KokkosFFT::Distributed::Impl::TopologyType::Brick);
    EXPECT_EQ(topo3_44, KokkosFFT::Distributed::Impl::TopologyType::Brick);
    EXPECT_EQ(topo3_55, KokkosFFT::Distributed::Impl::TopologyType::Brick);
    EXPECT_EQ(topo3_12, KokkosFFT::Distributed::Impl::TopologyType::Brick);
    EXPECT_EQ(topo3_13, KokkosFFT::Distributed::Impl::TopologyType::Brick);
    EXPECT_EQ(topo3_14, KokkosFFT::Distributed::Impl::TopologyType::Brick);
    EXPECT_EQ(topo3_15, KokkosFFT::Distributed::Impl::TopologyType::Brick);
    ...
    EXPECT_EQ(topo4_11, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_22, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_33, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_44, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_55, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_66, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_77, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_88, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_12, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_13, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_14, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_15, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_16, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_23, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_24, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
    EXPECT_EQ(topo4_25, KokkosFFT::Distributed::Impl::TopologyType::Invalid);
  }
}
...
void test_is_topology(std::size_t nprocs) {
  ...
  if (nprocs == 1) {
    ...
    // Invalid 1D topology
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology1D_type{0}));

    // 2D topology is slab
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology2_1));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology2_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology2_1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology2_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology2_1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology2_2));

    // Invalid 2D topology
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology2D_type{0, nprocs}));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology2D_type{nprocs, 0}));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology2D_type{0, nprocs}));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology2D_type{nprocs, 0}));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology2D_type{0, nprocs}));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology2D_type{nprocs, 0}));

    // 3D case
    // Pencil topologies
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_1));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_2));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_3));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology3_4));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology3_5));

    // 4D case
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_1));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_2));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_3));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_4));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_5));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_6));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology4_7));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology4_8));
  } else {
    // 1D topology
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
    ...
    // 3D topology
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology3_1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology3_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology3_3));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology3_4));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology3_5));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology3_1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology3_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology3_3));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology3_4));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology3_5));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_3));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_4));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_5));

    // 4D topology
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology4_1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology4_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology4_3));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology4_4));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology4_5));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology4_6));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology4_7));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology4_8));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology4_1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology4_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology4_3));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology4_4));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology4_5));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology4_6));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology4_7));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology4_8));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_2));
    ...
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_6));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_7));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_8));
  }
}
...
void test_are_topologies(std::size_t nprocs) {
  ...
  if (nprocs == 1) {
    // 1D topology is shared
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology1, topology1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology1, topology1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology1, topology1));

    // Invalid 1D topology
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology1D_type{0}, topology1));

    // 2D topology is slab
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology2_1, topology2_1));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology2_2, topology2_2));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology2_1, topology2_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology2_1, topology2_1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology2_2, topology2_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology2_1, topology2_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology2_2, topology2_1));

    // Invalid 2D topology
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology2D_type{0, nprocs}, topology2_1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology2D_type{nprocs, 0}, topology2_1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology2D_type{0, nprocs}, topology2_1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology2D_type{nprocs, 0}, topology2_1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology2D_type{0, nprocs}, topology2_1));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology2D_type{nprocs, 0}, topology2_1));

    // 3D case
    // Pencil topologies
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_1, topology3_2));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_2, topology3_3));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_3, topology3_1));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology3_4, topology3_4));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology3_5, topology3_5));

    // 4D case
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_1, topology4_2));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_2, topology4_3));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_3, topology4_4));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_4, topology4_5));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_5, topology4_6));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology4_7, topology4_7));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology4_8, topology4_8));
  } else {
    // 1D topology
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology1, topology1));
    ...
    // 2D topology
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology2_1, topology2_1));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology2_2, topology2_2));
    EXPECT_TRUE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology2_1, topology2_2));

    // 3D topology
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology3_1, topology3_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology3_2, topology3_3));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology3_3, topology3_4));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology3_4, topology3_5));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology3_1, topology3_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology3_2, topology3_3));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology3_3, topology3_4));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology3_4, topology3_5));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_1, topology3_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_2, topology3_3));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_3, topology3_4));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology3_4, topology3_5));

    // 4D topology
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology4_1, topology4_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology4_3, topology4_4));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology4_5, topology4_6));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Shared, topology4_7, topology4_8));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology4_1, topology4_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology4_3, topology4_4));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology4_5, topology4_6));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Slab, topology4_7, topology4_8));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_1, topology4_2));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_3, topology4_4));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_5, topology4_6));
    EXPECT_FALSE(KokkosFFT::Distributed::Impl::are_specified_topologies(
        TopologyType::Pencil, topology4_7, topology4_8));
  }
}
...
void test_get_all_pencil_topologies1D_3DView(std::size_t nprocs) {
  ...
  if (nprocs == 1) {
    ...
    auto ref_topologies_and_axes_0_0_1 =
    ...
    auto ref_topologies_and_axes_0_0_2 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo2, ref_topo0},
                        vec_axis_type{1, 1}, layouts_type{1, 0, 1});
    ...
    auto ref_topologies_and_axes_0_1_1 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo1}, vec_axis_type{0},
                        layouts_type{1, 1});
    EXPECT_EQ(topologies_and_axes_0_1_1, ref_topologies_and_axes_0_1_1);

    auto ref_topologies_and_axes_0_1_2 = std::make_tuple(
    ...
    auto ref_topologies_and_axes_0_2_1 = std::make_tuple(
    ...
    auto ref_topologies_and_axes_0_2_2 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo2}, vec_axis_type{1},
                        layouts_type{1, 0});
    ...
    auto ref_topologies_and_axes_1_0_1 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo0}, vec_axis_type{0},
                        layouts_type{1, 1});
    EXPECT_EQ(topologies_and_axes_1_0_1, ref_topologies_and_axes_1_0_1);

    auto ref_topologies_and_axes_1_0_2 = std::make_tuple(
    ...
    auto ref_topologies_and_axes_1_1_1 = std::make_tuple(
        topologies_type{ref_topo1}, vec_axis_type{}, layouts_type{1});
    EXPECT_EQ(topologies_and_axes_1_1_1, ref_topologies_and_axes_1_1_1);

    auto ref_topologies_and_axes_1_1_2 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo3, ref_topo1},
                        vec_axis_type{1, 1}, layouts_type{1, 1, 1});
    ...
    auto ref_topologies_and_axes_1_2_1 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo0, ref_topo2},
                        vec_axis_type{0, 1}, layouts_type{1, 1, 0});
    EXPECT_EQ(topologies_and_axes_1_2_1, ref_topologies_and_axes_1_2_1);

    auto ref_topologies_and_axes_1_2_2 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo0, ref_topo2},
                        vec_axis_type{0, 1}, layouts_type{1, 1, 0});
    ...
    auto ref_topologies_and_axes_2_0_1 = std::make_tuple(
    ...
    auto ref_topologies_and_axes_2_0_2 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo0}, vec_axis_type{1},
                        layouts_type{0, 1});
    ...
    auto ref_topologies_and_axes_2_1_1 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo0, ref_topo1},
                        vec_axis_type{1, 0}, layouts_type{0, 1, 1});
    EXPECT_EQ(topologies_and_axes_2_1_1, ref_topologies_and_axes_2_1_1);

    auto ref_topologies_and_axes_2_1_2 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo0, ref_topo1},
                        vec_axis_type{1, 0}, layouts_type{0, 1, 1});
    ...
    auto ref_topologies_and_axes_2_2_0 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo0, ref_topo2},
                        vec_axis_type{1, 1}, layouts_type{0, 1, 0});
    EXPECT_EQ(topologies_and_axes_2_2_0, ref_topologies_and_axes_2_2_0);

    auto ref_topologies_and_axes_2_2_1 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo4, ref_topo2},
                        vec_axis_type{0, 0}, layouts_type{0, 0, 0});
    EXPECT_EQ(topologies_and_axes_2_2_1, ref_topologies_and_axes_2_2_1);

    auto ref_topologies_and_axes_2_2_2 = std::make_tuple(
        topologies_type{ref_topo2}, vec_axis_type{}, layouts_type{0});
...
void test_get_all_pencil_topologies2D_3DView(std::size_t nprocs) {
  ...
  if (nprocs == 1) {
    ...
    auto ref_topologies_and_axes_0_0_20 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo2, ref_topo0},
                        vec_axis_type{1, 1}, layouts_type{1, 0, 1});
    EXPECT_EQ(topologies_and_axes_0_0_20, ref_topologies_and_axes_0_0_20);

    auto ref_topologies_and_axes_0_0_21 = std::make_tuple(
    ...
    auto ref_topologies_and_axes_0_2_02 = std::make_tuple(
        topologies_type{ref_topo0, ref_topo2, ref_topo0, ref_topo2},
        vec_axis_type{1, 1, 1}, layouts_type{1, 0, 1, 0});
    EXPECT_EQ(topologies_and_axes_0_2_02, ref_topologies_and_axes_0_2_02);

    auto ref_topologies_and_axes_0_2_10 = std::make_tuple(
        topologies_type{ref_topo0, ref_topo1, ref_topo0, ref_topo2},
        vec_axis_type{0, 0, 1}, layouts_type{1, 1, 1, 0});
    EXPECT_EQ(topologies_and_axes_0_2_10, ref_topologies_and_axes_0_2_10);

    auto ref_topologies_and_axes_0_2_12 = std::make_tuple(
    ...
    auto ref_topologies_and_axes_0_2_20 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo2}, vec_axis_type{1},
                        layouts_type{1, 0});
    EXPECT_EQ(topologies_and_axes_0_2_20, ref_topologies_and_axes_0_2_20);

    auto ref_topologies_and_axes_0_2_21 = std::make_tuple(
        topologies_type{ref_topo0, ref_topo1, ref_topo0, ref_topo2},
        vec_axis_type{0, 0, 1}, layouts_type{1, 1, 1, 0});
    ...
    auto ref_topologies_and_axes_1_0_02 = std::make_tuple(
        topologies_type{ref_topo1, ref_topo3, ref_topo1, ref_topo0},
        vec_axis_type{1, 1, 0}, layouts_type{1, 1, 1, 1});
    EXPECT_EQ(topologies_and_axes_1_0_02, ref_topologies_and_axes_1_0_02);

    auto ref_topologies_and_axes_1_0_10 = std::make_tuple(
    ...
    auto ref_topologies_and_axes_1_0_12 = std::make_tuple(
        topologies_type{ref_topo1, ref_topo3, ref_topo1, ref_topo0},
        vec_axis_type{1, 1, 0}, layouts_type{1, 1, 1, 1});
    EXPECT_EQ(topologies_and_axes_1_0_12, ref_topologies_and_axes_1_0_12);

    auto ref_topologies_and_axes_1_0_20 = std::make_tuple(
    ...
    auto ref_topologies_and_axes_1_0_21 = std::make_tuple(
        topologies_type{ref_topo1, ref_topo3, ref_topo1, ref_topo0},
        vec_axis_type{1, 1, 0}, layouts_type{1, 1, 1, 1});
    ...
    auto ref_topologies_and_axes_1_1_02 = std::make_tuple(
    ...
    auto ref_topologies_and_axes_1_1_21 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo3, ref_topo1},
                        vec_axis_type{1, 1}, layouts_type{1, 1, 1});
    ...
    auto ref_topologies_and_axes_1_2_02 = std::make_tuple(
    ...
    auto ref_topologies_and_axes_1_2_10 = std::make_tuple(
    ...
    auto ref_topologies_and_axes_1_2_12 = std::make_tuple(
    ...
    auto ref_topologies_and_axes_1_2_20 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo0, ref_topo2},
                        vec_axis_type{0, 1}, layouts_type{1, 1, 0});
    EXPECT_EQ(topologies_and_axes_1_2_20, ref_topologies_and_axes_1_2_20);

    auto ref_topologies_and_axes_1_2_21 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo0, ref_topo2},
                        vec_axis_type{0, 1}, layouts_type{1, 1, 0});
    ...
    auto ref_topologies_and_axes_2_0_02 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo0}, vec_axis_type{1},
                        layouts_type{0, 1});
    EXPECT_EQ(topologies_and_axes_2_0_02, ref_topologies_and_axes_2_0_02);

    auto ref_topologies_and_axes_2_0_10 = std::make_tuple(
    ...
    auto ref_topologies_and_axes_2_0_12 = std::make_tuple(
        topologies_type{ref_topo2, ref_topo4, ref_topo2, ref_topo0},
        vec_axis_type{0, 0, 1}, layouts_type{0, 0, 0, 1});
    EXPECT_EQ(topologies_and_axes_2_0_12, ref_topologies_and_axes_2_0_12);

    auto ref_topologies_and_axes_2_0_20 = std::make_tuple(
        topologies_type{ref_topo2, ref_topo0, ref_topo2, ref_topo0},
        vec_axis_type{1, 1, 1}, layouts_type{0, 1, 0, 1});
    EXPECT_EQ(topologies_and_axes_2_0_20, ref_topologies_and_axes_2_0_20);

    auto ref_topologies_and_axes_2_0_21 = std::make_tuple(
        topologies_type{ref_topo2, ref_topo4, ref_topo2, ref_topo0},
        vec_axis_type{0, 0, 1}, layouts_type{0, 0, 0, 1});
    ...
    auto ref_topologies_and_axes_2_1_21 = std::make_tuple(
    ...
    auto ref_topologies_and_axes_2_2_02 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo0, ref_topo2},
                        vec_axis_type{1, 1}, layouts_type{0, 1, 0});
    EXPECT_EQ(topologies_and_axes_2_2_02, ref_topologies_and_axes_2_2_02);

    auto ref_topologies_and_axes_2_2_10 = std::make_tuple(
...
void test_get_all_pencil_topologies2D_4DView(std::size_t nprocs) {
  ...
  if (nprocs == 1) {
    ...
    auto ref_topologies_and_axes_0_0_10 = std::make_tuple(
        topologies_type{ref_topo0}, vec_axis_type{}, layouts_type{1});
    EXPECT_EQ(topologies_and_axes_0_0_10, ref_topologies_and_axes_0_0_10);

    auto ref_topologies_and_axes_0_0_12 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo6, ref_topo0},
                        vec_axis_type{0, 0}, layouts_type{1, 1, 1});
    EXPECT_EQ(topologies_and_axes_0_0_12, ref_topologies_and_axes_0_0_12);
    ...
    auto ref_topologies_and_axes_0_0_21 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo6, ref_topo0},
                        vec_axis_type{0, 0}, layouts_type{1, 1, 1});
    EXPECT_EQ(topologies_and_axes_0_0_21, ref_topologies_and_axes_0_0_21);

    auto ref_topologies_and_axes_0_0_13 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo7, ref_topo0},
                        vec_axis_type{1, 1}, layouts_type{1, 0, 1});
    EXPECT_EQ(topologies_and_axes_0_0_13, ref_topologies_and_axes_0_0_13);

    auto ref_topologies_and_axes_0_0_23 = std::make_tuple(
        topologies_type{ref_topo0, ref_topo7, ref_topo9, ref_topo7, ref_topo0},
        vec_axis_type{1, 0, 0, 1}, layouts_type{1, 0, 0, 0, 1});
    EXPECT_EQ(topologies_and_axes_0_0_23, ref_topologies_and_axes_0_0_23);

    auto ref_topologies_and_axes_0_0_03 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo7, ref_topo0},
                        vec_axis_type{1, 1}, layouts_type{1, 0, 1});
    EXPECT_EQ(topologies_and_axes_0_0_03, ref_topologies_and_axes_0_0_03);
    ...
    auto ref_topologies_and_axes_0_1_02 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo1}, vec_axis_type{0},
                        layouts_type{1, 1});
    EXPECT_EQ(topologies_and_axes_0_1_02, ref_topologies_and_axes_0_1_02);
    ...
    auto ref_topologies_and_axes_0_1_20 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo1}, vec_axis_type{0},
                        layouts_type{1, 1});
    EXPECT_EQ(topologies_and_axes_0_1_20, ref_topologies_and_axes_0_1_20);

    auto ref_topologies_and_axes_0_1_21 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo1}, vec_axis_type{0},
                        layouts_type{1, 1});
    EXPECT_EQ(topologies_and_axes_0_1_21, ref_topologies_and_axes_0_1_21);

    auto ref_topologies_and_axes_0_1_13 = std::make_tuple(
        topologies_type{ref_topo0, ref_topo2, ref_topo0, ref_topo1},
        vec_axis_type{1, 1, 0}, layouts_type{1, 0, 1, 1});
    EXPECT_EQ(topologies_and_axes_0_1_13, ref_topologies_and_axes_0_1_13);

    auto ref_topologies_and_axes_0_1_23 = std::make_tuple(
        topologies_type{ref_topo0, ref_topo2, ref_topo0, ref_topo1},
        vec_axis_type{1, 1, 0}, layouts_type{1, 0, 1, 1});
    EXPECT_EQ(topologies_and_axes_0_1_23, ref_topologies_and_axes_0_1_23);

    auto ref_topologies_and_axes_0_1_03 = std::make_tuple(
        topologies_type{ref_topo0, ref_topo2, ref_topo0, ref_topo1},
        vec_axis_type{1, 1, 0}, layouts_type{1, 0, 1, 1});
    EXPECT_EQ(topologies_and_axes_0_1_03, ref_topologies_and_axes_0_1_03);
    ...
    auto ref_topologies_and_axes_0_2_10 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo2}, vec_axis_type{1},
                        layouts_type{1, 0});
    EXPECT_EQ(topologies_and_axes_0_2_10, ref_topologies_and_axes_0_2_10);
    ...
    auto ref_topologies_and_axes_0_2_20 = std::make_tuple(
        topologies_type{ref_topo0, ref_topo1, ref_topo0, ref_topo2},
        vec_axis_type{0, 0, 1}, layouts_type{1, 1, 1, 0});
    EXPECT_EQ(topologies_and_axes_0_2_20, ref_topologies_and_axes_0_2_20);
    ...
    auto ref_topologies_and_axes_0_2_21 = std::make_tuple(
        ...
        vec_axis_type{0, 0, 1}, layouts_type{1, 1, 1, 0});
    EXPECT_EQ(topologies_and_axes_0_2_21, ref_topologies_and_axes_0_2_21);
    auto ref_topologies_and_axes_0_2_13 = std::make_tuple(
        topologies_type{ref_topo0, ref_topo2, ref_topo0, ref_topo2},
        vec_axis_type{1, 1, 1}, layouts_type{1, 0, 1, 0});
    EXPECT_EQ(topologies_and_axes_0_2_13, ref_topologies_and_axes_0_2_13);
    auto ref_topologies_and_axes_0_2_23 = std::make_tuple(
        topologies_type{ref_topo0, ref_topo2, ref_topo4, ref_topo2},
        vec_axis_type{1, 0, 0}, layouts_type{1, 0, 0, 0});
    EXPECT_EQ(topologies_and_axes_0_2_23, ref_topologies_and_axes_0_2_23);
    auto ref_topologies_and_axes_0_2_03 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo2}, vec_axis_type{1},
                        layouts_type{1, 0});
    EXPECT_EQ(topologies_and_axes_0_2_03, ref_topologies_and_axes_0_2_03);
    ...
    EXPECT_EQ(topologies_and_axes_0_3_01, ref_topologies_and_axes_0_3_01);

    auto ref_topologies_and_axes_0_3_02 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo1, ref_topo3},
                        vec_axis_type{0, 1}, layouts_type{1, 1, 1});
    EXPECT_EQ(topologies_and_axes_0_3_02, ref_topologies_and_axes_0_3_02);

    auto ref_topologies_and_axes_0_3_10 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo1, ref_topo3},
                        vec_axis_type{0, 1}, layouts_type{1, 1, 1});
    EXPECT_EQ(topologies_and_axes_0_3_10, ref_topologies_and_axes_0_3_10);

    auto ref_topologies_and_axes_0_3_12 = std::make_tuple(
        topologies_type{ref_topo0, ref_topo1, ref_topo0, ref_topo1, ref_topo3},
        vec_axis_type{0, 0, 0, 1}, layouts_type{1, 1, 1, 1, 1});
    EXPECT_EQ(topologies_and_axes_0_3_12, ref_topologies_and_axes_0_3_12);

    auto ref_topologies_and_axes_0_3_20 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo1, ref_topo3},
                        vec_axis_type{0, 1}, layouts_type{1, 1, 1});
    EXPECT_EQ(topologies_and_axes_0_3_20, ref_topologies_and_axes_0_3_20);

    auto ref_topologies_and_axes_0_3_21 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo1, ref_topo3},
                        vec_axis_type{0, 1}, layouts_type{1, 1, 1});
    EXPECT_EQ(topologies_and_axes_0_3_21, ref_topologies_and_axes_0_3_21);

    auto ref_topologies_and_axes_0_3_13 = std::make_tuple(
        topologies_type{ref_topo0, ref_topo2, ref_topo0, ref_topo1, ref_topo3},
        vec_axis_type{1, 1, 0, 1}, layouts_type{1, 0, 1, 1, 1});
    EXPECT_EQ(topologies_and_axes_0_3_13, ref_topologies_and_axes_0_3_13);

    auto ref_topologies_and_axes_0_3_23 = std::make_tuple(
        topologies_type{ref_topo0, ref_topo2, ref_topo4, ref_topo5, ref_topo3},
        vec_axis_type{1, 0, 1, 0}, layouts_type{1, 0, 0, 0, 1});
    EXPECT_EQ(topologies_and_axes_0_3_23, ref_topologies_and_axes_0_3_23);

    auto ref_topologies_and_axes_0_3_03 =
        std::make_tuple(topologies_type{ref_topo0, ref_topo1, ref_topo3},
                        vec_axis_type{0, 1}, layouts_type{1, 1, 1});
    EXPECT_EQ(topologies_and_axes_0_3_03, ref_topologies_and_axes_0_3_03);
    ...
    auto ref_topologies_and_axes_1_0_02 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo0}, vec_axis_type{0},
                        layouts_type{1, 1});
    EXPECT_EQ(topologies_and_axes_1_0_02, ref_topologies_and_axes_1_0_02);

    auto ref_topologies_and_axes_1_0_10 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo0}, vec_axis_type{0},
                        layouts_type{1, 1});
    EXPECT_EQ(topologies_and_axes_1_0_10, ref_topologies_and_axes_1_0_10);

    auto ref_topologies_and_axes_1_0_12 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo0}, vec_axis_type{0},
                        layouts_type{1, 1});
    EXPECT_EQ(topologies_and_axes_1_0_12, ref_topologies_and_axes_1_0_12);

    auto ref_topologies_and_axes_1_0_20 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo0}, vec_axis_type{0},
                        layouts_type{1, 1});
    EXPECT_EQ(topologies_and_axes_1_0_20, ref_topologies_and_axes_1_0_20);
    ...
    auto ref_topologies_and_axes_1_0_13 = std::make_tuple(
        topologies_type{ref_topo1, ref_topo3, ref_topo1, ref_topo0},
        vec_axis_type{1, 1, 0}, layouts_type{1, 1, 1, 1});
    EXPECT_EQ(topologies_and_axes_1_0_13, ref_topologies_and_axes_1_0_13);

    auto ref_topologies_and_axes_1_0_23 = std::make_tuple(
        topologies_type{ref_topo1, ref_topo3, ref_topo1, ref_topo0},
        vec_axis_type{1, 1, 0}, layouts_type{1, 1, 1, 1});
    EXPECT_EQ(topologies_and_axes_1_0_23, ref_topologies_and_axes_1_0_23);

    auto ref_topologies_and_axes_1_0_03 = std::make_tuple(
        topologies_type{ref_topo1, ref_topo3, ref_topo1, ref_topo0},
        vec_axis_type{1, 1, 0}, layouts_type{1, 1, 1, 1});
    EXPECT_EQ(topologies_and_axes_1_0_03, ref_topologies_and_axes_1_0_03);
    ...
    auto ref_topologies_and_axes_1_1_13 = std::make_tuple(
        topologies_type{ref_topo1, ref_topo9, ref_topo7, ref_topo9, ref_topo1},
        vec_axis_type{1, 0, 0, 1}, layouts_type{1, 0, 0, 0, 1});
    EXPECT_EQ(topologies_and_axes_1_1_13, ref_topologies_and_axes_1_1_13);

    auto ref_topologies_and_axes_1_1_23 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo9, ref_topo1},
                        vec_axis_type{1, 1}, layouts_type{1, 0, 1});
    EXPECT_EQ(topologies_and_axes_1_1_23, ref_topologies_and_axes_1_1_23);

    auto ref_topologies_and_axes_1_1_03 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo9, ref_topo1},
                        vec_axis_type{1, 1}, layouts_type{1, 0, 1});
    EXPECT_EQ(topologies_and_axes_1_1_03, ref_topologies_and_axes_1_1_03);
    ...
    auto ref_topologies_and_axes_1_2_02 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo0, ref_topo2},
                        vec_axis_type{0, 1}, layouts_type{1, 1, 0});
    EXPECT_EQ(topologies_and_axes_1_2_02, ref_topologies_and_axes_1_2_02);

    auto ref_topologies_and_axes_1_2_10 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo0, ref_topo2},
                        vec_axis_type{0, 1}, layouts_type{1, 1, 0});
    EXPECT_EQ(topologies_and_axes_1_2_10, ref_topologies_and_axes_1_2_10);

    auto ref_topologies_and_axes_1_2_12 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo0, ref_topo2},
                        vec_axis_type{0, 1}, layouts_type{1, 1, 0});
    ...
    auto ref_topologies_and_axes_1_2_21 = std::make_tuple(
        topologies_type{ref_topo1, ref_topo0, ref_topo1, ref_topo0, ref_topo2},
        vec_axis_type{0, 0, 0, 1}, layouts_type{1, 1, 1, 1, 0});
    EXPECT_EQ(topologies_and_axes_1_2_21, ref_topologies_and_axes_1_2_21);

    auto ref_topologies_and_axes_1_2_13 = std::make_tuple(
        topologies_type{ref_topo1, ref_topo3, ref_topo5, ref_topo4, ref_topo2},
        vec_axis_type{1, 0, 1, 0}, layouts_type{1, 1, 0, 0, 0});
    EXPECT_EQ(topologies_and_axes_1_2_13, ref_topologies_and_axes_1_2_13);

    auto ref_topologies_and_axes_1_2_23 = std::make_tuple(
        topologies_type{ref_topo1, ref_topo3, ref_topo1, ref_topo0, ref_topo2},
        vec_axis_type{1, 1, 0, 1}, layouts_type{1, 1, 1, 1, 0});
    EXPECT_EQ(topologies_and_axes_1_2_23, ref_topologies_and_axes_1_2_23);

    auto ref_topologies_and_axes_1_2_03 =
        std::make_tuple(topologies_type{ref_topo1, ref_topo0, ref_topo2},
                        vec_axis_type{0, 1}, layouts_type{1, 1, 0});
    EXPECT_EQ(topologies_and_axes_1_2_03, ref_topologies_and_axes_1_2_03);
    ...
    auto ref_topologies_and_axes_2_0_02 = std::make_tuple(
        topologies_type{ref_topo2, ref_topo4, ref_topo2, ref_topo0},
        vec_axis_type{0, 0, 1}, layouts_type{0, 0, 0, 1});
    EXPECT_EQ(topologies_and_axes_2_0_02, ref_topologies_and_axes_2_0_02);

    auto ref_topologies_and_axes_2_0_10 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo0}, vec_axis_type{1},
                        layouts_type{0, 1});
    EXPECT_EQ(topologies_and_axes_2_0_10, ref_topologies_and_axes_2_0_10);
    ...
    auto ref_topologies_and_axes_2_0_13 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo0}, vec_axis_type{1},
                        layouts_type{0, 1});
    EXPECT_EQ(topologies_and_axes_2_0_13, ref_topologies_and_axes_2_0_13);

    auto ref_topologies_and_axes_2_0_23 = std::make_tuple(
        topologies_type{ref_topo2, ref_topo4, ref_topo2, ref_topo0},
        vec_axis_type{0, 0, 1}, layouts_type{0, 0, 0, 1});
    EXPECT_EQ(topologies_and_axes_2_0_23, ref_topologies_and_axes_2_0_23);

    auto ref_topologies_and_axes_2_0_03 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo0}, vec_axis_type{1},
                        layouts_type{0, 1});
    EXPECT_EQ(topologies_and_axes_2_0_03, ref_topologies_and_axes_2_0_03);
    ...
    auto ref_topologies_and_axes_2_1_12 = std::make_tuple(
        topologies_type{ref_topo2, ref_topo4, ref_topo5, ref_topo3, ref_topo1},
        vec_axis_type{0, 1, 0, 1}, layouts_type{0, 0, 0, 1, 1});
    EXPECT_EQ(topologies_and_axes_2_1_12, ref_topologies_and_axes_2_1_12);

    auto ref_topologies_and_axes_2_1_20 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo0, ref_topo1},
                        vec_axis_type{1, 0}, layouts_type{0, 1, 1});
    EXPECT_EQ(topologies_and_axes_2_1_20, ref_topologies_and_axes_2_1_20);

    auto ref_topologies_and_axes_2_1_21 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo0, ref_topo1},
                        vec_axis_type{1, 0}, layouts_type{0, 1, 1});
    EXPECT_EQ(topologies_and_axes_2_1_21, ref_topologies_and_axes_2_1_21);

    auto ref_topologies_and_axes_2_1_13 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo0, ref_topo1},
                        vec_axis_type{1, 0}, layouts_type{0, 1, 1});
    EXPECT_EQ(topologies_and_axes_2_1_13, ref_topologies_and_axes_2_1_13);

    auto ref_topologies_and_axes_2_1_23 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo0, ref_topo1},
                        vec_axis_type{1, 0}, layouts_type{0, 1, 1});
    EXPECT_EQ(topologies_and_axes_2_1_23, ref_topologies_and_axes_2_1_23);

    auto ref_topologies_and_axes_2_1_03 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo0, ref_topo1},
                        vec_axis_type{1, 0}, layouts_type{0, 1, 1});
    EXPECT_EQ(topologies_and_axes_2_1_03, ref_topologies_and_axes_2_1_03);
    ...
    auto ref_topologies_and_axes_2_2_01 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo7, ref_topo2},
                        vec_axis_type{1, 1}, layouts_type{0, 0, 0});
    EXPECT_EQ(topologies_and_axes_2_2_01, ref_topologies_and_axes_2_2_01);

    auto ref_topologies_and_axes_2_2_02 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo10, ref_topo2},
                        vec_axis_type{0, 0}, layouts_type{0, 1, 0});
    EXPECT_EQ(topologies_and_axes_2_2_02, ref_topologies_and_axes_2_2_02);

    auto ref_topologies_and_axes_2_2_10 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo7, ref_topo2},
                        vec_axis_type{1, 1}, layouts_type{0, 0, 0});
    EXPECT_EQ(topologies_and_axes_2_2_10, ref_topologies_and_axes_2_2_10);
    ...
    auto ref_topologies_and_axes_2_2_21 = std::make_tuple(
        topologies_type{ref_topo2, ref_topo7, ref_topo9, ref_topo7, ref_topo2},
        vec_axis_type{1, 0, 0, 1}, layouts_type{0, 0, 0, 0, 0});
    EXPECT_EQ(topologies_and_axes_2_2_21, ref_topologies_and_axes_2_2_21);

    auto ref_topologies_and_axes_2_2_13 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo7, ref_topo2},
                        vec_axis_type{1, 1}, layouts_type{0, 0, 0});
    EXPECT_EQ(topologies_and_axes_2_2_13, ref_topologies_and_axes_2_2_13);

    auto ref_topologies_and_axes_2_2_23 =
        std::make_tuple(topologies_type{ref_topo2, ref_topo10, ref_topo2},
                        vec_axis_type{0, 0}, layouts_type{0, 1, 0});
    EXPECT_EQ(topologies_and_axes_2_2_23, ref_topologies_and_axes_2_2_23);

    auto ref_topologies_and_axes_2_2_03 = std::make_tuple(
        topologies_type{ref_topo2}, vec_axis_type{}, layouts_type{0});
    EXPECT_EQ(topologies_and_axes_2_2_03, ref_topologies_and_axes_2_2_03);
    ...
    EXPECT_EQ(topologies_and_axes_3_0_23, ref_topologies_and_axes_3_0_23);
  }
}
