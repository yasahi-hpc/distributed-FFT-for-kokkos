...
static void benchmark_unpack(benchmark::State& state) {
  ...
  using dst_shape_type = std::array<std::size_t, DIM>;
  ...
  auto dst_extents = KokkosFFT::Distributed::Impl::compute_mapped_extents(
...
BENCHMARK_Unpack(Kokkos::complex<double>, LayoutLeft, 3, 3, 0, 64, 1024, 16,
                 64);
BENCHMARK_Unpack(Kokkos::complex<double>, LayoutLeft, 3, 3, 1, 64, 1024, 16,
                 64);
BENCHMARK_Unpack(Kokkos::complex<double>, LayoutLeft, 3, 3, 2, 64, 1024, 16,
                 64);

BENCHMARK_Unpack(Kokkos::complex<double>, LayoutRight, 3, 3, 0, 64, 1024, 16,
                 64);
BENCHMARK_Unpack(Kokkos::complex<double>, LayoutRight, 3, 3, 1, 64, 1024, 16,
                 64);
BENCHMARK_Unpack(Kokkos::complex<double>, LayoutRight, 3, 3, 2, 64, 1024, 16,
                 64);
